...
const BlueBox = () => {
    ...
    return (
        <div className="blue-box" >
            <div className="blue-boxes" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className="step-one">
                    ...
                    <span className="blue-content">Go to the <a href="#" className="sign-red">sign up</a> page and fill your registration details appropriately.
